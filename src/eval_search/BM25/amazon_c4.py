...
if __name__ == '__main__':
    ...
    parser.add_argument('--domain', type=str, choices=['Games', 'Baby', 'Office', 'Sports'], default='Games')
    parser.add_argument('--test_data_dir', type=str, default='data/amazon_c4/test_subset')
