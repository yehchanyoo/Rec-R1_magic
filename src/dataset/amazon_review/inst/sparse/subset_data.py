...
PROMPT = """You are an intelligent shopping assistant that helps predict what users may want to purchase next. Below is a list of items a user has purchased recently. Your task is to infer what kind of product they may want to buy next, and generate relevant query terms that can be used to search for the next potential product. 
