...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='data/amazon_c4/inst/subset_other')
    
    args = parser.parse_args()
    
    domain_name_list = ['Video_Games', 'Baby', 'Office', 'Sports']
    
    data_source = f'amazon_c4'
    data_source_dict = {ele: f'amazon_c4_{ele}' for ele in domain_name_list}
